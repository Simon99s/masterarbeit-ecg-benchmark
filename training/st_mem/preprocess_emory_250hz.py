...
OUTPUT_DIR = Path(r"C:\Users\simon\Desktop\bm\training\st_mem")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_PATH = OUTPUT_DIR / "heedb_i0006_250hz_preprocessed.h5"
...
with h5py.File(INPUT_PATH, "r") as fin, h5py.File(OUTPUT_PATH, "w") as fout:
    ...
    # ✅ Chunked dataset (VERY IMPORTANT)
    fout.create_dataset(
        "data",
    ...
    for start in range(0, N, BATCH_SIZE):
        ...
        # 🔥 EIN großer Read statt viele kleine
        batch = X[start:end]
